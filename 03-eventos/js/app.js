...
function renderizarTareas(){
  ...
  if(tareas.length === 0){
    ...
    contadorTareas.textContent = '0 pendiente(s)'; // Corregido "pendientes(s)" a "pendiente(s)"
    return;
  }
...
function agregarTarea(){
  // CORRECCIÓN: variable 'texto' en lugar de 'text'
  ...
  tareas.push({
    id: Date.now(),
    texto, // Ahora sí coincide con la variable
    completada: false
  });
